...
class Series extends Component {
    render() {
        return (
            <section id="series" classNameName="section-padding">
                <div classNameName="container">
                    <div className="row">
                        <div className="col-12">
                            <div className="col-12">
                                <div className="section-title-header text-center">
                                    <h1 class="section-title wow fadeInUp" data-wow-delay="0.2s">Series</h1>
                                    <p class="wow fadeInDown color" data-wow-delay="0.2s">Diferentes Series en diferentes formatos (1080p, 720p).</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
